...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'proyectos/nuevo/derivado/:initiativeCode', title: 'PIIP | Proyecto derivado', loadComponent: () => import('./pages/derived-project-form/derived-project-form.component').then((module) => module.DerivedProjectFormComponent) },
